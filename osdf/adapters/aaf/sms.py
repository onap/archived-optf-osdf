...
def load_secrets():
    ...
    config['osdfPlacementUsername'] = "test"
    config['osdfPlacementPassword'] = "testpwd"
    config['soUsername'] = ""
    config['soPassword'] = ""
    config['conductorUsername'] = ""
    config['conductorPassword'] = ""
    config['policyPlatformUsername'] = ""
    config['policyPlatformPassword'] = ""
    config['policyClientUsername'] = ""
    config['policyClientPassword'] = ""
