...
from osdf.adapters.conductor.demand import Demand
...
def _build_parameters(group_policies, service_info, request_parameters):
    ...
    if service_info:
        params.update({"service_name": service_info['serviceName']})
        params.update({"service_id": service_info['serviceInstanceId']})
