...
class TestDes(unittest.TestCase):
    ...
    def test_extract_data(self):
        ...
        self.assertEqual(expected, des.extract_data(service_id, data, self.osdf_config))
        ...
        self.patcher_req = patch('requests.post', return_value=response)
        self.Mock_req = self.patcher_req.start()
        self.assertRaises(DESException, des.extract_data, service_id, data, self.osdf_config)
        self.patcher_req.stop()
