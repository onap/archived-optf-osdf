# -------------------------------------------------------------------------
#   Copyright (c) 2022 DTAG Property
#
...
"""
This application generates NSST SELECTION API calls using the information received from SO
"""
import os
...
# This is the class for NSST Selection
...
class NsstSelection(Thread):
    ...
    def get_nsst_selection_response(self, solutions):
        """Get NSST selection response from final solution

            :param solutions: final solutions
            :return: NSST selection response to send back as dictionary
        """
